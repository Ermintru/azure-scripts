...
workflow updatedynipvpn
{
    ...
    #>
	$Cred = Get-AutomationPSCredential -name "AzAutomation@mestuartm.onmicrosoft.com"
	Add-AzureAccount –Credential $Cred
	$AzureSubscriptionName = "Microsoft Partner Network" #change to your. I'm using my MSDN benefits in the lab.
	...
	{	
    	...
    	#>
		$DynDNS = "remote.stuartm.net" #change to yours
		...
		$MyLocalSoHoNetworkInAzure = "StuartM-VNET-LNG"
